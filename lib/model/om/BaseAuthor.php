...
abstract class BaseAuthor extends BaseObject  implements Persistent
{
  ...
  public function setAge($v)
  {
    ...
    {
      $this->age = $v;
      $this->modifiedColumns[] = AuthorPeer::AGE;
    }
  ...
  public function hydrate($row, $startcol = 0, $rehydrate = false)
  {
    try
    {
      ...
      return $startcol + 5; // 5 = AuthorPeer::NUM_HYDRATE_COLUMNS.
  ...
  protected function doInsert(PropelPDO $con)
  {
    ...
    if ($this->isColumnModified(AuthorPeer::AGE))
    {
  ...
  public function buildCriteria()
  {
    ...
    if ($this->isColumnModified(AuthorPeer::AGE)) $criteria->add(AuthorPeer::AGE, $this->age);
  ...
  {
    $this->booksScheduledForDeletion = $this->getBooks(new Criteria(), $con)->diff($books, false);
   ...
   * @return     PropelCollection|array Book[] List of Book objects
   */
  public function getBooksJoinPublisher($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
  {
    $query = BookQuery::create(null, $criteria);
  ...
  public function __call($name, $params)
  {
    ...
    // symfony_behaviors behavior
    if ($callable = sfMixer::getCallable('BaseAuthor:' . $name))
    {
