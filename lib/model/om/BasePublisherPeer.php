...
/**
 * Base static class for performing query and update operations on the 'publisher' table.
 *
 * 
 *
...
abstract class BasePublisherPeer
{
  ...
  public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
  {
    ...
    {
      call_user_func($sf_hook, 'BasePublisherPeer', $criteria, $con);
    }
   ...
   *
   * @param      Publisher $value A Publisher object.
  ...
  /**
   * Method to invalidate the instance pool of all tables related to publisher
  ...
  {
    return $withPrefix ? PublisherPeer::CLASS_DEFAULT : PublisherPeer::OM_CLASS;
  }
  ...
  public static function doInsert($values, PropelPDO $con = null)
  {
    ...
    if ($criteria->containsKey(PublisherPeer::ID) && $criteria->keyContainsValue(PublisherPeer::ID) )
    {
  ...
  public static function doUpdate($values, PropelPDO $con = null)
  {
    ...
    if ($values instanceof Criteria)
    {
      ...
      $value = $criteria->remove(PublisherPeer::ID);
      if ($value)
      {
        $selectCriteria->add(PublisherPeer::ID, $value, $comparison);
      }
      else
      {
  ...
  static private function getMixerPreSelectHook($method)
  {
    ...
    {
      return sprintf('BasePublisherPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
    }
