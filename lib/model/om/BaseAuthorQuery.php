 ...
 * @method     AuthorQuery orderByAge($order = Criteria::ASC) Order by the age column
 *
 ...
 * @method     AuthorQuery groupByAge() Group by the age column
 *
 ...
 * @method     Author findOneByAge(int $age) Return the first Author filtered by the age column
 *
 ...
 * @method     array findByAge(int $age) Return Author objects filtered by the age column
 *
...
abstract class BaseAuthorQuery extends ModelCriteria
{
  ...
  public function filterByAge($age = null, $comparison = null)
  {
    if (is_array($age))
    {
      ...
      if (isset($age['min']))
      {
        $this->addUsingAlias(AuthorPeer::AGE, $age['min'], Criteria::GREATER_EQUAL);
        $useMinMax = true;
      }
      if (isset($age['max']))
      {
        $this->addUsingAlias(AuthorPeer::AGE, $age['max'], Criteria::LESS_EQUAL);
        $useMinMax = true;
      }
      if ($useMinMax)
      {
    ...
    return $this->addUsingAlias(AuthorPeer::AGE, $age, $comparison);
  }
